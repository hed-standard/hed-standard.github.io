 ...
 * https://github.com/hed-standard/hed-specification/tree/HED-restructure/hedxml-restruct
 * and build githubSchema global variable
 */
function getGithubSchema() {
    $.ajax({dataType: "json", url: "https://api.github.com/repos/hed-standard/hed-specification/contents/hedxml-restruct?ref=HED-restructure", async: false, success: function(data) {
